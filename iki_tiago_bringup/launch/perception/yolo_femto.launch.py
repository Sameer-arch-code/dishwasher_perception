...
def generate_launch_description():
    ...
    def run_yolo(context: LaunchContext, use_tracking, use_3d):
        ...
        config_dir = os.path.join(config_pkg_share, "config", "perception")

        tracker_file_name = "yolo_bytetrack.yml"
        tracker_file_path = os.path.join(config_dir, tracker_file_name)
        ...
        model_cmd = DeclareLaunchArgument(
            "model",
            default_value="/models/yolo11x-pose.pt",
        ...
        tracker_cmd = DeclareLaunchArgument(
            "tracker",
            default_value=tracker_file_path,
        ...
        input_image_topic_cmd = DeclareLaunchArgument(
            "input_image_topic",
            default_value="/femto_bolt/color/image_raw",
        ...
        input_depth_topic_cmd = DeclareLaunchArgument(
            "input_depth_topic",
            default_value="/femto_bolt/depth/image_raw",
        ...
        input_depth_info_topic_cmd = DeclareLaunchArgument(
            ...
            default_value="/femto_bolt/depth/camera_info",
