...
def generate_launch_description():
    ...
    params_file_arg = DeclareLaunchArgument(
        "params_file",
        default_value=os.path.join(get_package_share_directory('iki_tiago_bringup'), "config", "sensors", "femto_bolt.yaml"),
    ...
    def launch_setup(context, *args, **kwargs):
        ...
        compose_node = ComposableNode(
            ...
            name=params.get("camera_name", "femto_bolt"),
        ...
        container = ComposableNodeContainer(
            name=PythonExpression(["'", params.get("camera_name", "femto_bolt"), "'", " + '_container'"]),
            namespace=params.get("namespace", ""),
